...
function setup() {
  ...
  box9 = new Box(700, 170, 70, 70);
  box10 = new Box(700, 240, 70, 70);
  box11 = new Box(700, 310, 70, 70);
  box12 = new Box(700, 380, 70, 70);
  box13 = new Box(700, 450, 70, 70);
  box14 = new Box(800, 100, 70, 70);
  box15 = new Box(800, 170, 70, 70);
  box16 = new Box(800, 240, 70, 70);
  box17 = new Box(800, 310, 70, 70);
  box18 = new Box(800, 380, 70, 70);
  box19 = new Box(800, 450, 70, 70);
  box20 = new Box(800, 520, 70, 70);
  box21 = new Box(800, 590, 70, 70);
